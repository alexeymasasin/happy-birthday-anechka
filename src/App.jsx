		...
		<div className="container__main">
			...
			<div className="typed-strings regular-1">
				<p>
					...
					смущаюсь, когда вижу тебя на фото. я обожаю твои ямочки на щеках,
					обожаю твои носогубные полосочки, твои прекрасные глаза, твои волосы,
					твои аккуратные ручки, пальчики, ножки, все твои родинки, каждый
					миллиметр твоего тела меня очарорвывает.
					<br />
					<br />
					...
					не так.
					<br />
					хоть я и понимал, что тебе было нужно время, мне всё равно тебя не
					хватало.
					<br />
					<br />
					...
					<br />
					<br />
					я знаю, ты тоже скучаешь и любишь меня, но тебе страшно.
					<br />
