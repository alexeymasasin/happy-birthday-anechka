		...
		<div className="container__main">
			...
			<div className="typed-strings regular-1">
				<p>
					...
					вообще в разы лучше, просто тем, что ты есть. прямо как лучик света в
					пасмурный день.
					<br />
					<br />
					даже после всего, что мы друг другу наговорили, я каждый раз, думая о
					тебе, ловлю себя на том, что ты всё ещё та же зая, от одной мысли о
					которой у меня пархают бабочки в животе, в груди взрываются
					...
					<br />
					<br />
					и хоть мы молчим и сильно ссоримся уже две недели, я всё ещё чувствую
					волнение, когда слышу твоё имя, с улыбкой думаю о тебе каждую секунду,
					пересматриваю твои фото, вспоминаю все наши моменты, — как мы играли в
					стардью в новогоднюю ночь, проходили тестики, вместе смотрели фильмы,
					сериалы, мультики, видео... как ты рисовала, пока я писал музыку, как
					мы засыпали в звонке, готовили вместе, строили планы на будущее (и ещё
					много-много всего). а ведь это было совсем недавно...
					<br />
					...
					когда мы уже сможем найти общий язык и помириться... и я смогу
					повставлять сирень в твои волосы {'>:)'}
					<br />
					...
					всём, и так будет всегда, ведь моя любовь к тебе без условий. я
					бесконечно счастлив, что судьба однажды свела нас вместе.{' '}
					...
					<br />
					что бы ты ни сказала мне, что бы ни сделала, я всегда буду любить
					тебя.
					<br />
					<br />
					...
					из-за меня ты так долго чувствуешь себя плохо.
					<br />
					...
					же всё обсудить, разобрать, понять тебя как можно скорее. а ты и сама
					себя понять не могла, бедняжка...
					<br />
					...
					<br />
					<br />
					я не знал, что мои попытки «решить всё сейчас» для тебя выглядели как
					давление и атаки, а твои попытки отойти от эмоций мне ложно казались
					отстраненностью и игнорированием.
					<br />
					<br />и хотя это всё было вправду ужасно, знай, что я делал это не
					ради контроля и давления, а от переизбытка чувств и страха тебя
					потерять.
					...
					слова, отличающиеся от тех, которые я тогда хотел услышать. это было
					глупо и эгоистично, ведь любые твои слова для меня ценны, вне
					зависимости от их значения, — они твои.
					<br />
					<br />
					...
					<br />
					<br />
					это поздравление, как и подарочки (если ты их уже получила) сделаны не
					для того, чтобы вывести тебя на разговор или как-то надавить. ты
					можешь даже спасибо не говорить, — я прекрасно понимаю твоё
					самочувствие и эмоции. я просто очень хотел сделать тебе приятно.
					<br />
					<br />
