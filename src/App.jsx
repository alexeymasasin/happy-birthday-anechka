		...
		<div className="container__main">
			...
			<div className="typed-strings regular-1">
				<p>
					...
					каждую секунду. даже если шанс того, что эти слова по-настоящему
					дойдут до тебя, невелик, я не могу промолчать. потому что ты
					заслуживаешь это слышать <span className="green">=)</span>
					<br /> <br />
					...
					{'-/-/-/-/-/-/-/-/-/-/-'}
					<br /> <br />
					эх, как же незаметно пролетел ещё один год... год, в которым ты, как
					...
					пупсичка, от которой у меня как и раньше в животе пархают бабочки, в
					груди взрываются фейерверки, а в голове крутится только одна мысль —{' '}
					<span className="red">
					...
					<br />
					<br />
					хоть мы и играем в эту молчану, я всё ещё постоянно вспоминаю все наши
					...
					пока я писал музыку, как мы засыпали в звонке, готовили вместе (и ещё
					много-много всего).
					...
					встретимся ирл, если ты, конечно, захочешь...
					<br />
					...
					это не что-то, что можно брать и сваливать на любимого человека, а моя
					личная ответственность и забота. не твоя. эти недели молчания
					...
					собой, над тем, чтобы стать по-настоящему надёжным.
					<br />
					<br />я знаю, что ты боишься. боишься того, что если простишь меня, то
					всё повторится. что я снова начну трястись, тревожиться из-за
					пустяков, обижаться из-за выдуманных вещей. но я больше не хочу
					...
					<br />
					<br />
					ты — моя родственная душа в этом мире, мой самый близкий и любимый
					человек, мой котёночек. я бесконечно благодарен тебе за каждый момент,
					проведённый вместе со мной, — даже за те, в которых мы ругались.
					спасибо тебе за всё, анечка.
					<br /> <br />
					{'-/-/-/-/-/-/-/-/-/-/-'}
					<br />
