		...
		<div className="container__main">
			...
			<div className="typed-strings regular-1">
				<p>
					...
					и пожелать тебе, ведь ты — самое светлое и важное, что есть (или было)
					в моей жизни. я просто не могу молчать, правда, тем более в такой
					важный день. ты слишком дорога мне.
					<br /> <br />
					{'-/-/-/-/-/-/-/-/-/-/-'}
					<br /> <br />
					...
					ответы, отличающиеся от тех, которые я хотел увидеть. я просто дурак.
					<br />
					<br />
					...
					дотошничать из-за надуманных вещей.
					<br />
					...
					пожалуйста... мне жаль, что мои беспокойства стали такой тяжелой
					ношей.
					<br />
					<br />
