		...
		<div className="container__main">
			...
			<div className="typed-strings regular-1">
				<p>
					...
					дать тебе его, пусть и получалось не очень.
					<br />
					<br />
					но сегодня — твой день, и я не хочу, чтобы ты думала, что мне всё
					равно. ты заслуживаешь услышать это всё, несмотря на все
					обстоятельства <span className="green">=)</span>
					...
					<br /> <br />я изо всех сил старался держаться подальше, потому что
					уважаю твоё решение, не хочу давить и тревожить, но мне ТАК много
					хочется сказать и пожелать тебе в этот день... ведь ты — самое светлое
					и важное, что есть в моей жизни, поэтому, пожалуйста, просто прими
					этот текст как{' '}
					<span className="purple">
						знак, что ты важна, несмотря на любую дистанцию
					</span>
					.
					<br /> <br />
					пожалуйста, проверь круглую коробочку на машином шкафу со стороны
					кровати, чёрный пакет на нижней полке в холодильнике и балкон.
					<br /> <br />
					{'-/-/-/-/-/-/-/-/-/-/-'}
					<br /> <br />
					блин,{' '}
					...
					<br />
					<br />
					ты <span className="red">красивее всех на свете</span>, — не только
					внешне, но и каждой частичкой своей души. я до сих пор смущаюсь, когда
					вижу тебя на фото. я обожаю твои ямочки на щеках, твои носогубные
					полосочки, твои прекрасные глаза, особенно когда ты улыбаешься...
					обожаю твои волосы, твои милые и аккуратные ручки, ножки, пальчики,
					все твои родинки и шрамики, да каждый твой миллиметр для меня —
					изысканность.
					<br />
					<br />
					ты самый чудесный и интересный человек на свете, моё «самое-самое»
					абсолютно во всём, и так будет всегда. аня, я бесконечно счастлив, что
					судьба однажды свела нас вместе.{' '}
					...
					и пространство, а мне наоборот, сразу же обсудить всё, понять тебя как
					можно скорее. а ты и сама себя понять не могла, бедняжка...
					<br />
					<br />я хочу чтобы ты знала, что сейчас я всеми силами учусь:
					<br />
					...
					здесь и сейчас».
					<br />я не понимал, что мои попытки «решить всё сейчас» для тебя
					...
					<br />
					<br />
					мне очень стыдно за то, что я сковывал твою свободу, устраивал
					бесконечные расспросы и так долго не слышал тебя, обижался, пока твоя
					мама не объяснила мне всё, что ты всегда пыталась мне сказать. я уже
					никогда не посмотря на себя по-прежнему.
					<br />
					<br />
					...
					этим и над тем, чтобы стать по-настоящему сильным и понимающим рядом с
					тобой, принимать тебя в любом состоянии, быть рядом без требований.
					<br />
					<br />
					...
					плане.
					<br />
					но и ты знай, что я больше не хочу подобного, — хочу лишь быть тем,
					кто <span className="green">защищает твой покой</span>,{' '}
					<span className="red">а не нарушает его</span>.
					<br />
					<br />я осознал, как сильно моя мнительность ранила тебя. я понял, что
					был не прав и ошибался в некоторые моменты,{' '}
					<span className="blue">
						даже буквально на днях, когда снова написал тебе
					</span>
					.
					<br />
					но теперь я готов быть другим — без давления, без тревог, которые так
					душили тебя, без ощущения недоверия, которое тебя ранило. просто
					надёжным мальчиком, который всегда рядом без каких-либо требований.
					<br />
					<br />
					я очень виноват перед тобой, дорогая. пожалуйста, прости меня, если
					сможешь.
					<br />
					<br />
					я всё ещё верю в нас и очень надеюсь, что в один день у нас ещё всё
					может наладиться. понимаю, что тебе нужно ещё больше времени и
					пространства, чтобы подумать, но если ты захочешь поговорить — знай, я
					всегда здесь.
					<br />
					как бы ни было больно, я принимаю твоё решение. больше не лезу, но
					никуда не пропадаю, как и моя любовь к тебе.
					<br />
					<br />
					это поздравление, как и все подарочки (если ты их уже получила) — не
					попытка нарушить твои границы, вывести на разговор или как-то
					надавить. ты можешь просто прочитать его и не ответить, никаких
					скрытых ожиданий тут нет — я прекрасно понимаю твоё состояние и
					эмоции. я не цепляюсь ни за что, а просто искренне люблю, и очень
					хотел сделать тебе приятно и всё.
					<br />
					<br />
					...
					<br />
					не думай о плохом!!! это твой день, кушай тортик и наслаждайся собой,
					ты заслуживаешь только самого хорошего!!
					<br /> <br />
					{'-/-/-/-/-/-/-/-/-/-/-'}
					<br />
					<br />с любовью, твой лёшенька
