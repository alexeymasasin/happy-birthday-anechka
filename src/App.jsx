		...
		<div className="container__main">
			...
			<div className="typed-strings regular-1">
				<p>
					...
					равно.
					<br /> я знаю, что ты тоже скучаешь по мне, и это молчание каждую
					секунду съедает меня изнутри.
					<br />
					...
					и пожелать тебе, ведь ты — самое светлое и важное, что есть в моей
					жизни. я просто не могу молчать, правда, тем более в такой важный
					день. ты слишком дорога мне.
					<br /> <br />
					{'-/-/-/-/-/-/-/-/-/-/-'}
					<br /> <br />
					...
					— твоё присутствие, пусть даже где-то далеко, меняет всё вокруг к
					лучшему.
					<br />
					<br />
					...
					<br />
					хотя, если честно, я в этот день чувствую, что это у меня праздник, а
					ты мой подарочек, хахчхзчхз
					<br />
					...
					<br />
					<br />
					и хоть мы и играем в эту молчанку уже две недели, я всё ещё думаю о
					тебе каждую секунду, просматриваю твои фото, вспоминаю все наши
					моменты, — как мы играли в стардью в новогоднюю ночь, проходили
					...
					<br />
					я, как полный идиот, не видел, что мои попытки «решить всё сейчас» для
					...
					не умела.
					<br />
					всё, что от меня требовалось — это просто быть рядом в трудную минуту,
					воздержаться от вопросов и разговоров о тревоге, когда ты напрямую об
					этом просила.
					<br />
					...
					<br />
					я ненавижу себя за то, что постоянно выражал недовольство и обиду за
					...
					<br />
					я и в дальнейшем что угодно сделаю, любовь моя, — всё, что ты
					попросишь, лишь бы тебе было хорошо...
					<br />
					<br />
					я знаю, ты тоже скучаешь, но тебе страшно.
					<br />
					страшно, что если простишь меня и откроешься снова, то всё повторится.
					что я снова начну трястись, тревожиться из-за пустяков, обижаться
					из-за надуманных вещей. но я больше не хочу такого, — хочу лишь быть
					тем, кто защищает твой покой, а не нарушает его. я осознал, как мои
					поступки постоянно ранили тебя. понял, где был не прав, проработал
					свои страхи и готов быть другим с тобой. без тревог, которые душили
					тебя, без ощущения недоверия, которое тебя ранило. мне жаль, что мои
					беспокойства стали для тебя такой тяжелой ношей.
					<br />
					<br />
					милая, я очень виноват перед тобой. прости меня, дурака, пожалуйста...
					<br />
					<br />
					ты заслуживаешь чувствовать себя спокойно и защищенно в этой жизни,
					правда, и я всё, что в моих силах будет сделаю, чтобы тебе жилось
					настолько комфортно счастливо, насколько это возможно.
					<br />
					<br />
			...
			<div className="gif">
				...
				<p className="gif_annotation">я очень тебя люблю, моё солнышко!!!</p>
			</div>
		</div>
	);
}
